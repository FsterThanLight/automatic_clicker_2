...
class Ui_Global(object):
    def setupUi(self, Global):
        ...
        self.label_3 = QtWidgets.QLabel(Global)
        ...
        self.gridLayout.addWidget(self.pushButton_10, 2, 5, 1, 1)
    ...
    def retranslateUi(self, Global):
        ...
        self.label_3.setText(_translate("Global", "工作表名："))
        self.label_4.setText(_translate("Global", "分支名："))
        self.label_5.setText(_translate("Global", "扩展程序："))
        self.pushButton_5.setText(_translate("Global", "添加"))
        self.pushButton_6.setText(_translate("Global", "删除"))
