...
class Ui_Branch(object):
    def setupUi(self, Branch):
        ...
        self.pushButton_2 = QtWidgets.QPushButton(Branch)
        font = QtGui.QFont()
        font.setFamily("微软雅黑")
        font.setBold(True)
        font.setWeight(75)
    ...
    def retranslateUi(self, Branch):
        ...
        self.label.setText(_translate("Branch", "双击名称或使用快捷键执行分支"))
        item = self.tableWidget.horizontalHeaderItem(0)
        item.setText(_translate("Branch", "分支名称"))
        item = self.tableWidget.horizontalHeaderItem(1)
        item.setText(_translate("Branch", "快捷键"))
        self.pushButton_2.setText(_translate("Branch", "更改为当前快捷键"))
