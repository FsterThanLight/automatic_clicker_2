...
"color: rgb(255, 255, 255);")
        ...
        icon7 = QtGui.QIcon()
        icon7.addPixmap(QtGui.QPixmap(":/按钮图标/窗体/res/导入指令.png"), QtGui.QIcon.Normal, QtGui.QIcon.Off)
        ...
        icon8 = QtGui.QIcon()
        icon8.addPixmap(QtGui.QPixmap(":/按钮图标/窗体/res/关于.png"), QtGui.QIcon.Normal, QtGui.QIcon.Off)
        self.actionabout.setIcon(icon8)
        self.actionabout.setObjectName("actionabout")
        self.actionj = QtWidgets.QAction(MainWindow)
        icon9 = QtGui.QIcon()
        icon9.addPixmap(QtGui.QPixmap(":/按钮图标/窗体/res/更新.png"), QtGui.QIcon.Normal, QtGui.QIcon.Off)
        self.actionj.setIcon(icon9)
        self.actionj.setObjectName("actionj")
        self.actionhelp = QtWidgets.QAction(MainWindow)
        icon10 = QtGui.QIcon()
        icon10.addPixmap(QtGui.QPixmap(":/按钮图标/窗体/res/帮助.png"), QtGui.QIcon.Normal, QtGui.QIcon.Off)
        self.actionhelp.setIcon(icon10)
        self.actionhelp.setObjectName("actionhelp")
        self.actionb = QtWidgets.QAction(MainWindow)
        icon11 = QtGui.QIcon()
        icon11.addPixmap(QtGui.QPixmap(":/按钮图标/窗体/res/保存.png"), QtGui.QIcon.Normal, QtGui.QIcon.Off)
        self.actionb.setIcon(icon11)
        self.actionb.setObjectName("actionb")
        self.setting = QtWidgets.QAction(MainWindow)
        icon12 = QtGui.QIcon()
        icon12.addPixmap(QtGui.QPixmap(":/按钮图标/窗体/res/设置.png"), QtGui.QIcon.Normal, QtGui.QIcon.Off)
        self.setting.setIcon(icon12)
        self.setting.setObjectName("setting")
        self.actionf = QtWidgets.QAction(MainWindow)
        self.actionf.setIcon(icon7)
        self.actionf.setObjectName("actionf")
        self.actions_2 = QtWidgets.QAction(MainWindow)
        self.actions_2.setIcon(icon12)
