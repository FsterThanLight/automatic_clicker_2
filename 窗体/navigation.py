...
class Ui_navigation(object):
    def setupUi(self, navigation):
        ...
        self.comboBox_7 = QtWidgets.QComboBox(navigation)
        ...
        self.label_32 = QtWidgets.QLabel(navigation)
    ...
    def retranslateUi(self, navigation):
        ...
        self.groupBox.setTitle(_translate("navigation", "Excel文件"))
        self.pushButton_7.setText(_translate("navigation", "选取文件"))
        self.label_33.setText(_translate("navigation", "表格："))
        self.label_34.setText(_translate("navigation", "开始行号："))
        self.groupBox_2.setTitle(_translate("navigation", "目标图像"))
        self.pushButton_8.setText(_translate("navigation", "选取图像文件夹"))
        self.label_35.setText(_translate("navigation", "当前文件夹："))
        self.label_36.setText(_translate("navigation", "暂无"))
        self.groupBox_3.setTitle(_translate("navigation", "控制"))
        self.checkBox_3.setText(_translate("navigation", "行号递增"))
        self.radioButton_3.setText(_translate("navigation", "图像名称对应列号"))
        self.radioButton_4.setText(_translate("navigation", "图像名称对应顺序"))
        self.tabWidget.setTabText(self.tabWidget.indexOf(self.tab_9), _translate("navigation", "数据录入"))
        self.label_21.setText(_translate("navigation", "重复次数："))
        self.comboBox_7.setItemText(0, _translate("navigation", "自动跳过"))
        self.comboBox_7.setItemText(1, _translate("navigation", "抛出异常并暂停"))
        self.comboBox_7.setItemText(2, _translate("navigation", "抛出异常并终止"))
        self.comboBox_7.setItemText(3, _translate("navigation", "转到分支1"))
        self.comboBox_7.setItemText(4, _translate("navigation", "转到分支2"))
        self.comboBox_7.setItemText(5, _translate("navigation", "转到分支3"))
        self.comboBox_7.setItemText(6, _translate("navigation", "转到分支4"))
        self.comboBox_7.setItemText(7, _translate("navigation", "转到分支5"))
        self.label_32.setText(_translate("navigation", "异常处理："))
